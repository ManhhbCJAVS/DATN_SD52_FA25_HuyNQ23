...
import edu.poly.datn_sd52_fa25_huynq203.library.service.product.attribute.MidSoleService;
...
@RestController
@RequestMapping("${backoffice.endpoint}/mid-soles")
@FieldDefaults(level = lombok.AccessLevel.PRIVATE, makeFinal = true)
@RequiredArgsConstructor
@Validated
@Slf4j
public class MidSoleController extends AbstractBaseAttributeController<
        MidSole,
        Long,
